...
@router.get("/list", response_model=list[BacktestStatusOut])
...
@router.post("/submit", response_model=BacktestStatusOut, status_code=status.HTTP_201_CREATED)
...
@router.get("/{job_id}", response_model=BacktestStatusOut)
