...
import { Button, Card, Input, Space, Tag, Tooltip, message } from "antd";
import {
  ClearOutlined,
  RobotOutlined,
  SendOutlined,
  ...
  return (
    <PageScaffold>
      <Card
        ...
        className="flex-1"
        classNames={{ body: "flex-1 flex flex-col gap-3 min-h-0" }}
      >
        <div
          ref={scrollRef}
        ...
        >
          {messages.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-slate-400">
              ...
              <p className="text-base text-slate-700 font-medium mb-1">问我点什么吧</p>
              <p className="text-sm">例如：现在 A 股大盘怎么看？双均线策略适合什么行情？</p>
            </div>
          ) : (
